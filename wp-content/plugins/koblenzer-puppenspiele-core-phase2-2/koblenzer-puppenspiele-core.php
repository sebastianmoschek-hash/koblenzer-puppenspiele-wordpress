...
require_once KP_CORE_DIR . 'includes/class-kp-text-patcher.php';
require_once KP_CORE_DIR . 'includes/class-kp-section-action-applier.php';
require_once KP_CORE_DIR . 'includes/class-kp-save-transaction.php';
...
require_once KP_CORE_DIR . 'includes/class-kp-owner-ui-polish.php';
