(() => {
  ...
  function liveAiToggleClass(on){document.documentElement.classList.toggle('kp-fe2-live-ai-on',!!on);document.querySelector('.kp-fe2-live-ai-toggle')?.classList.toggle('is-on',!!on);document.querySelector('.kp-fe2-live-ai-launch')?.classList.toggle('is-open',!!on);}
