...
(() => {
  ...
  function themeSheet() {
    ...
    const presets = { original: { preset: 'original-koblenz', colors: { accent: '#f28b35', background: '#2b1c16', surface: '#17100d', text: '#fff7ef', muted: '#d7c5b8' } }, warm: { preset: 'warm-theater', colors: { accent: '#f6ad55', background: '#3a2119', surface: '#22110e', text: '#fff8ee', muted: '#e2c5b4' } }, night: { preset: 'night-stage', colors: { accent: '#eab308', background: '#111827', surface: '#080d18', text: '#f8fafc', muted: '#cbd5e1' } }, poster: { preset: 'theatre-poster', colors: { accent: '#ffcc33', background: '#401411', surface: '#210a09', text: '#fff8e8', muted: '#e8c9af' } }, gallery: { preset: 'gallery-light', colors: { accent: '#b65c2d', background: '#efe4d2', surface: '#fffaf1', text: '#251812', muted: '#765f52' } }, forest: { preset: 'evening-forest', colors: { accent: '#f2b744', background: '#17332c', surface: '#0e211d', text: '#f6f2e7', muted: '#c3d1c4' } } };
    const panel = document.createElement('div'); panel.id = 'kpV2ThemeSheet';
    panel.innerHTML = '<header><div><strong>Website-Design</strong><small>Inhalte bleiben unverändert</small></div><button type="button" data-close>×</button></header><div class="kp-v2-theme-grid"><button type="button" data-theme="original">Original</button><button type="button" data-theme="warm">Warmes Theater</button><button type="button" data-theme="night">Nachtbühne</button><button type="button" data-theme="poster">Theaterplakat</button><button type="button" data-theme="gallery">Helle Galerie</button><button type="button" data-theme="forest">Abendgrün</button></div><footer><button type="button" data-cancel>Verwerfen</button><button type="button" data-accept disabled>Übernehmen</button></footer>';
