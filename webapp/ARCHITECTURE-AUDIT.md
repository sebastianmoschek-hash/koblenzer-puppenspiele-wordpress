...
Stand: 2026-09-13. Zulässiger Branch: `webapp-no-wordpress-test`.
...
- `editor-v2-overlay.js`: kontextabhängige V2-Werkzeugleiste, responsive Ansichten, Abschnittsvorlagen, Abschnitts-/Navigations-/Header-/Theme- und KI-Statusoberflächen.
