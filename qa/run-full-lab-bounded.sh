...
publish_remote_diagnostics(){
  ...
  : > "$diag"
  for logfile in pipeline.log editor.log section-actions.log link-safety.log ai-chat.log session-undo.log persistence.log touch-slider.log touch-runtime.log visual.log php-syntax.log deploy.log; do
