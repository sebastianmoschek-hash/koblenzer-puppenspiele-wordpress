...
try {
  for (const viewport of viewports) {
    ...
    result.sectionDesignUI = await page.evaluate(() => window.KPEditorV2.store.get().document.pages[0].sections.find(section => section.id === 'aktuell')?.design?.backgroundColor === '#3a2119');
    await page.evaluate(() => window.KPEditorV2.store.undo());
