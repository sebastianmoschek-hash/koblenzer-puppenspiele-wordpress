...
const safe = `      } else if (input.type === 'color') {\n        // Shared staging must never receive synthetic colour values. Keep the\n        // current colour in the expected persistence set without mutating it.\n        changed[key] = input.value;`;
...
console.log('PASS: shared-staging E2E colour mutations neutralized.');
